...
int IN4 = 5;
int ENB = 3;
#define MIN_ABS_SPEED 31 //27 28 30
...
void loop() {///
  ...
  Serial.print(x2);
  Serial.print(",  Angle: ");
  Serial.print(int(KalmanFilter(x3,chtime*1000000000)));
  x4=((KalmanFilter(x3,chtime*1000000000)-x3_ant)/chtime);
  ...
  x1_ant=x1;
  x3_ant=KalmanFilter(x3,chtime*1000000000);
}
